...
const required = ['goPage','redeemDeal','viewWalletDeal','markDealUsed','shareDealFromModal','calculateDiscount','setDiscountSymbol','setHasExpiry','saveDealForm','confirmShare','claimFromPool','claimBrowseDeal','doSpin','closeModal'];
