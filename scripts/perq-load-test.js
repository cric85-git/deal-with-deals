...
const required = ['goPage','redeemDeal','viewWalletDeal','markDealUsed','shareDealFromModal','calculateDiscount','confirmShare','claimFromPool','claimBrowseDeal','doSpin','closeModal'];
