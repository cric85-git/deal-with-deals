...
const required = ['goPage','redeemDeal','viewWalletDeal','markDealUsed','shareDealFromModal','deleteDealFromModal','calculateDiscount','setDiscountSymbol','setHasExpiry','saveDealForm','toggleDealImage','confirmShare','claimFromPool','claimBrowseDeal','doSpin','closeModal','openPendingDealOnReady','testNotification','findDuplicateDeal'];
