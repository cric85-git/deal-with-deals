# Perq Rewards gamification study
...
- Make Rewards feel tangible. The Rewards tab now has a daily savings run with a claimable completion bonus, a reward wallet with redeemable actions, and plain-language wheel odds so users understand what they are working toward.
